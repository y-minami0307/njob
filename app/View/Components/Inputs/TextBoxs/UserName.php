...
class UserName extends Component
{
    ...
    public function __construct(
        public readonly string $id = 'user-name',
        public readonly string $name = 'user_name',
        public readonly array $classs = array(),
        public readonly string $value = '',
        public readonly int $maxlength = \UserConst::MAX_LENGTH_USER_NAME,

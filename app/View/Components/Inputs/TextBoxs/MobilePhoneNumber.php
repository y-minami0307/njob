...
/**
 * 携帯電話番号テキストボックス Component
 * 
 */
class MobilePhoneNumber extends Component
{
    /**
     * __construct
     *
    ...
    public function __construct(
        public readonly string $id = 'mobile-phone-number',
        public readonly string $name = 'mobile_phone_number',

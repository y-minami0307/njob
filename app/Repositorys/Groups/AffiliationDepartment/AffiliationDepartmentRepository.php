 ...
 * 
 */
class AffiliationDepartmentRepository implements AffiliationDepartmentRepositoryInterface
{
    /**
     * 所属部門を取得
     * 
    ...
    {
        return AffiliationDepartment::whereAffiliationCodeId($affiliation_id)->whereDepartmentCodeId($department_id)->first();
    }
    ...
    {
        return AffiliationDepartment::with('groupCodes')->find($id);
    }
}